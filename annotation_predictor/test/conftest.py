...
from settings import annotation_predictor_dir, class_ids_oid_file
...
test_dict = {
    'nottest_id': [OrderedDict(
        [('Source', 'freeform'), ('LabelName', '/m/05656'), ('Confidence', '0.8'), ('XMin', '0.5'), ('XMax', '0.3'),
         ('YMin', '0.9'), ('YMax', '0.7'), ('IsOccluded', '0'), ('IsTruncated', '1'), ('IsGroupOf', '0'),
         ('IsDepiction', '0'), ('IsInside', '1')])],
    'test_id': test_data,
    'test_id_fake': [OrderedDict(
        [('Source', 'freeform'), ('LabelName', '/m/01234'), ('Confidence', '0.1'), ('XMin', '0.8'), ('XMax', '0.4'),
         ('YMin', '0.3'), ('YMax', '0.4'), ('IsOccluded', '0'), ('IsTruncated', '0'), ('IsGroupOf', '1'),
         ('IsDepiction', '0'), ('IsInside', '1')])]}
